   ...
   function buildStyle(urlpicture){
                        ...
                        if (valueCMH==1){
                            ...
                            if(valueDFW==1){
                                ...
                                if(valueLAX==1){
                                    ...
                                    if(valueORD==1){
                                        return "5732p000000H7L6";
                                    }
                                    else{
                                        //*************English_Agents*********************
                                        return "5732p000000H7JU";
                                    }
                                }
                            }
                        } 
	...
	//--getButtonId end here--
        ...
        if(session){
         ...
         if(sessiondata && sessiondata.authenticated && sessiondata.authenticated.lastName){
        ...
        embedded_svc.init(
            'https://ceva.my.salesforce.com',
			'https://cview.secure.force.com/service',
			gslbBaseURL,
			'00D2000000078N1',
			'Service_Queue',
			{
...
function populateFormFields(){
	...
	if(document.getElementById('ContactKontainersId__c') != null){
