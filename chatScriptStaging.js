...
(function() {
   ...
   function buildStyle(urlpicture){
        ...
        style.innerHTML += `.embeddedServiceHelpButton .helpButton { position: fixed;height: 81px;bottom: 0;} `; 
		...
		style.innerHTML +=  `.embeddedServiceHelpButton .helpButton .helpButtonEnabled:hover::before, .embeddedServiceHelpButton .helpButton .helpButtonEnabled:focus::before { opacity: 0;}`;
    ...
    function getButtonId() { 
            ...
            //Chinese customer            
            //var userRegion = "Tianjin";
            //var userLang = "zh";
            
            //English customer
            //var userRegion = "Alabama";
            //var userLang = "en";
            
            //alert ("The language is:" + userLang);
            //alert ("The userRegion is:" + userRegion);
            //alert ("The Countryis:" + userCountry);
            ...
            if(userCountry!== ""){            
                ...
                if(userCountry.includes("US") || userCountry.includes("MX") || userCountry.includes("CA")){
                    ...
                    if(userLang.includes("en")){
                        ...
                        if (valueCMH==1){
                            alert("valueCMH-->"+valueCMH); 
                            return "5731j00000000ej";    
                        }
                        else{ 
                            //*************DFW_English_Agents*********************
                            var valueDFW = 0;
                            ...
                            if(valueDFW==1){
                                alert("valueDFW--->"+valueDFW); 
                                return "5731j00000000eo";
                            }
                            else{
                                //*************LAX_English_Agents*********************
                                var valueLAX = 0;
                                ...
                                if(valueLAX==1){
                                    alert("valueLAX --->"+valueLAX); 
                                    return "5731j00000000et";
                                }
                                else{
                                    //*************ORD_English_Agents*********************
                                    var valueORD = 0;
                                    ...
                                    if(valueORD==1){
                                        alert("valueORD --->"+valueORD); 
                                        return "5731j00000000ey";
                                    }
                                    else{
                                        //*************English_Agents*********************
                                        alert("english agent");
                                        return "5732p000000H7J5";
                                    }
                                }
                            }
                        } 
                ...
                // ************ CHINA Digital agents**************
                    ...
                    if(userLang.includes("zh")){
                        ...
                        if (valueSHA==1){
                            alert("valueSHA-->"+valueSHA); 
                            return "5731j00000000f3";    
                        }
                        else{
                            //*************SHZ_Chinese_Agents*********************
                            var valueSHZ = 0;
                            ...
                            if(valueSHZ==1){
                                alert("valueSHZ --->"+valueSHZ); 
                                return "5731j00000000f8";
                            }
                            else{
                                //*************Chinese_Agents*********************
                                alert("chinese agent");
                    ...
                    //English speaking customer           
                        ...
                        if (valueSHAe==1){
                            alert("valueSHAe-->"+valueSHAe); 
                            return "5731j00000000fm";    
                        }
                        else{
                            //*************SHZ_Chinese_Agents*********************
                            var valueSHZe = 0;
                            ...
                            if(valueSHZe==1){
                                alert("valueSHZe --->"+valueSHZe); 
                                return "5731j00000000fr";
                            }
                            else{
                                //*************English_Agents*********************
                                alert("chinese agent");
                ...
                // ************ INDIA Digital agents**************
                    ...
                    if(userLang.includes("hi")){
                        ...
                        if (valueBOM==1){
                            alert("valueBOM-->"+valueBOM); 
                            return "5731j00000000fD";    
                        }
                        else{
                            //*************MAA_Hindi_Agents*********************
                            var valueMAA = 0;
                            ...
                            if(valueMAA==1){
                                alert("valueMAA --->"+valueMAA); 
                                return "5731j00000000fI";
                            }
                            else{
                                //*************Hindi_Agents*********************
                                alert("Hindi agent");
                    ...
                    //English speaking customer
                        ...
                        if (valueBOMe==1){
                            alert("valueBOMe-->"+valueBOMe); 
                            return "5731j00000000fN";    
                        }
                        else{
                            //*************MAA_English_Agents*********************
                            var valueMAAe = 0;
                            ...
                            if(valueMAAe==1){
                                alert("valueMAAe --->"+valueMAAe); 
                                return "5731j00000000fS";
                            }
                            else{
                                //*************English_Agents*********************
                                alert("English agent");
                ...
                // ************ JAPAN Digital agents**************
                    ...
                    if(userLang.includes("ja")){
                        ...
                        if (valueTOK ==1){
                            alert("valueTOK -->"+valueTOK ); 
                            return "5731j00000000fX";    
                        }
                        else{
                            //*************Japanese_Agents*********************
                            alert("Japanese agent");
                            return "";
                        }    
                    }
                    //English speaking customer
                        ...
                        if (valueTOKe ==1){
                            alert("valueTOKe -->"+valueTOKe ); 
                            return "5731j00000000fw";    
                        }
                        else{
                            //*************English_Agents*********************
                            alert("English agent");
                ...
                // ************ KOREA Digital agents**************
                    ...
                    if(userLang.includes("ko")){
                        ...
                        if (valueBUS ==1){
                            alert("valueBUS -->"+valueBUS  ); 
                            return "5731j00000000fc";    
                        }
                        else{
                            //*************Korean_Agents*********************
                            alert("Korean agent");
                    ...
                    if(userLang.includes("en")){
                        ...
                        if (valueBUSe ==1){
                            alert("valueBUSe -->"+valueBUSe  ); 
                            return "5731j00000000g1";    
                        }
                        else{
                            //*************English_Agents*********************
                            alert("English agent");
                ...
                // ************ TAIWAN Digital agents**************
                    ...
                    if(userLang.includes("tw")){
                        ...
                        if (valueTPE ==1){
                            alert("valueTPE -->"+valueTPE ); 
                            return "5731j00000000fh";    
                        }
                        else{
                            //*************Taiwan_Agents*********************
                            alert("Taiwan agent");
                     ...
                     //English speaking customer
                        ...
                        if (valueTPeE ==1){
                            alert("valueTPEe -->"+valueTPEe ); 
                            return "5731j00000000g6";    
                        }
                        else{
                            //*************English_Agents*********************
                            alert("English agent");
    ...
    // getbuttonId end here
        ...
        if(sessiondata && session && sessiondata.authenticated && sessiondata.authenticated.lastName){
        ...
        embedded_svc.init(
            'https://ceva--servicejun.my.salesforce.com',
            'https://servicejun-cview.cs102.force.com/service',
            gslbBaseURL,
            '00D1j0000000tr9',
            'Service_Queue',
            {
                baseLiveAgentContentURL: 'https://c.la1-c1cs-cdg.salesforceliveagent.com/content',
                deploymentId: '5722p000000LImV',
